...
\fig{img/token_length}{Distributon of the document length}{fig:dist-token-length}{0.65}
...
\fig{img/accuracy}{Comparison of model accuracy with TF-IDF and BoW}{fig:perf-acc}{1}
...
\fig{img/runtime}{Comparison of model runtime with TF-IDF and BoW}{fig:perf-runtime}{1}
