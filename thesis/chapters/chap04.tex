...
\fig{img/accuracy}{Comparison of model accuracy with TFIDF and BOW}{fig:perf-acc}{1}
...
\fig{img/runtime}{Comparison of model runtime with TFIDF and BOW}{fig:perf-runtime}{1}
